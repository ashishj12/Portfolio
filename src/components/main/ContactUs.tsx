...
import { buttonVariants } from '../sub/ui/button';
            ...
            >
              ...
              <div className="space-y-5 text-foreground">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">jangidashish38@gmail.com</span>
                  <button
                    onClick={() => copyToClipboard('jangidashish38@gmail.com', 'Email')}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">+91 8690869917</span>
                  <button
                    onClick={() => copyToClipboard('+91 8690869917', 'Phone number')}
                    className="text-muted-foreground hover:text-primary transition"
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium select-text">Jaipur, India</span>
                </div>
              </div>
            </motion.div>

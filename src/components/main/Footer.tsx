...
const Footer: FC = () => {
  ...
  const socialLinks = [
    ...
    {
      href: 'https://www.linkedin.com/in/ashish-kumar-60429724b/',
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          <motion.div className="space-y-4" variants={childVariants}>
            <h1 className="text-2xl font-extrabold bg-clip-text">Ashish Kumar</h1>
            <p className="text-sm text-muted-foreground leading-relaxed">
              Building scalable, efficient, and secure backend systems with Node.js and modern
        ...
        >
          <p className="text-xs text-muted-foreground">
            © {new Date().getFullYear()} Built with ❤️ by Ashish Kumar.
          </p>
          <p className="text-xs text-muted-foreground">
            Visitors:{' '}

...
import { Badge } from '../sub/ui/badge';
import { BentoGrid, BentoGridItem } from '../sub/ui/bento-grid';

const projectsData = [
  {
    title: 'EduTrack - An AI-Powered Attendance System',
    description: 'AI-driven attendance system using NLP and MTCNN, MERN stack.',
    imageURL: '/edutrack.png',
    github: 'https://github.com/ashishj12/EduTrack',
    live: 'https://github.com/ashishj12/EduTrack',
    icon: <IconClipboardCopy className="h-4 w-4 text-muted-foreground" />,
  },
  {
    title: 'MockMate - Mock Interview Platform',
    description: 'AI-powered mock interview platform with real-time feedback and analytics.',
    imageURL: '/mockmate.png',
    github: 'https://github.com/ashishj12/mockmate',
    live: 'https://mockmate-omega.vercel.app/',
    icon: <IconFileBroken className="h-4 w-4 text-muted-foreground" />,
  },
  {
    title: 'BookNest - Book Ecommerce Platform',
    description: 'Full-stack book ecommerce platform with user auth, product management.',
    imageURL: '/booknest.png',
    github: 'https://github.com/ashishj12/Books_Store',
    live: 'https://books-store-alpha.vercel.app/',
  ...
  {
    title: 'Learn Golang',
    description: 'Learn Golang with interactive examples and exercises.',
    imageURL: '/golang.jpeg',
    github: 'https://github.com/ashishj12/Go-Learning',
    live: 'https://github.com/ashishj12/Go-Learning',

    ...
    >
      ...
      >
        ...
        <PointerHighlight rectangleClassName="rounded-none">
          <span className="text-primary p-3 text-3xl lg:text-6xl">Backend Developer</span>
        </PointerHighlight>
        <span className="text-base text-muted-foreground italic max-w-[500px] mx-auto">
          Building scalable, efficient, and secure backend systems with Node.js and modern backend
          technologies.{' '}
        </span>
      </motion.div>
